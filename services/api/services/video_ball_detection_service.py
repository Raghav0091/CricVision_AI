...
def run_video_ball_detection_job(
    ...
    try:
        ...
        video_ball_detection_job_store.update(
            ...
            ball_detector_model_key=summary.ball_detector_model_key,
            ball_detector_model_name=summary.ball_detector_model_name,
            error_message=None,
...
def _process_video_ball_detection(
    ...
    model_key = job["ball_detector_model_key"]
    try:
        selected_model, model = load_ball_detector_model(model_key)
    except InvalidBallDetectorModelKey as exc:
        raise VideoBallDetectionError(str(exc), status_code=400) from exc
    ...
    video_ball_detection_job_store.update(
        ...
        ball_detector_model_key=selected_model.key,
